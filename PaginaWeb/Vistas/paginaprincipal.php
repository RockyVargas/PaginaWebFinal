...
<body>
    ...
    <div class="container">
        <main>
            <!-- Aquí es donde quieres mostrar los productos -->
            <div class="cudrito">
                <?php
                include '../Modelos/conexionpaginainicio.php';
                ?>
            </div>
        </main>
        <div id="carrito">
    ...
    <div id="botones">
        <button class="left_btn" id="left_btn" name="left_btn" onclick="cambiarPagina(-1)">
            <img src="../images/IZQUIERDA.png" alt="" class="left_btn-img">
        </button>
        <button class="right_btn" id="right_btn" name="right_btn" onclick="cambiarPagina(1)">
